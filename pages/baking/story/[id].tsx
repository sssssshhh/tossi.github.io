  ...
  return (
    <div className="w-full h-full px-14 py-28 flex flex-col justify-center items-center space-y-10">
      <div className="h-1/4 flex flex-col justify-center items-center text-center space-y-3">
        <div className="text-base	text-amber-700 pb-3">2023.07.18</div>
          <div className="text-3xl text-amber-700">빵에 설탕, 많이 들어가야 하는 이유는 무엇일까?</div>
      ...
      <div className="w-3/4 h-3/4 space-y-4 border-t-2 p-20 text-base tracking-wide leading-relaxed">
        <p className="py-5">
          <strong className="text-2xl">음식을 바라보는 우리의 시각</strong>
        </p>
        <p>
