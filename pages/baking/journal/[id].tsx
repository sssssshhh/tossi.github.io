...
export default function Detail() {
  ...
  const journals: Journal[]  = [
    ...
    {"id": 1, "title": "나쁜 설탕? 착한 설탕?", "img": "https://images.unsplash.com/photo-1628619876503-2db74e724757?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1510&q=80", "content": ""},
 ];
  
  const journal: Story = journals.filter(
  ...
  return (
    <div className="w-full h-full px-14 py-28 flex flex-col justify-center items-center space-y-10">
      <div className="h-1/4 flex flex-col justify-center items-center text-center space-y-3">
          <div className="text-3xl text-amber-700">{journal.title}</div>
      </div>
